...
//Static methods
  ...
  public static double RadiusVector(double JD)
  {
	...
	//Calculate R0
    int nR0Coefficients = GFX.g_R0SaturnCoefficients.Length;
	double R0 = 0;
	int i;
	...
	//Calculate R1
	int nR1Coefficients = GFX.g_R1SaturnCoefficients.Length;
	double R1 = 0;
	...
	//Calculate R2
	int nR2Coefficients = GFX.g_R2SaturnCoefficients.Length;
	double R2 = 0;
	...
	//Calculate R3
	int nR3Coefficients = GFX.g_R3SaturnCoefficients.Length;
	double R3 = 0;
	...
	//Calculate R4
	int nR4Coefficients = GFX.g_R4SaturnCoefficients.Length;
	double R4 = 0;
	...
	//Calculate R5
	int nR5Coefficients = GFX.g_R5SaturnCoefficients.Length;
	double R5 = 0;
