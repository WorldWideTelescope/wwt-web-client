...
//Static methods
  ...
  public static double Interpolate2(double n, double Y1, double Y2, double Y3, double Y4, double Y5)
  {
	double A = Y2 - Y1;
	double B = Y3 - Y2;
	double C = Y4 - Y3;
  ...
  //  return (Y2 - ((ab *ab)/(8 *c)));
  //}
  //public static double Extremum2(double Y1, double Y2, double Y3, double Y4, double Y5, ref double nm)
  //{
  //  double A = Y2 - Y1;
  //  double B = Y3 - Y2;
  //  double C = Y4 - Y3;
  ...
  //  return Interpolate2(nm, Y1, Y2, Y3, Y4, Y5);
  //}
  ...
  public static double ZeroB(double Y1, double Y2, double Y3, double Y4, double Y5)
  {
	double A = Y2 - Y1;
	double B = Y3 - Y2;
	double C = Y4 - Y3;
  ...
  public static double Zero2B(double Y1, double Y2, double Y3, double Y4, double Y5)
  {
	double A = Y2 - Y1;
	double B = Y3 - Y2;
	double C = Y4 - Y3;
