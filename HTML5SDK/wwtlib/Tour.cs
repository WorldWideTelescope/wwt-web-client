...
namespace wwtlib
{
    public class Tour : IThumbnail
    {
        ...
        internal static Tour FromXml(System.Xml.XmlNode child)
        {
            ...
            {
                switch (child.Attributes.GetNamedItem("Classification").Value)
                {

                    case "Star":
                        temp.Classification = Classification.Star;
                        break;
                    case "Supernova":
                        temp.Classification = Classification.Supernova;
                        break;
                    case "BlackHole":
                        temp.Classification = Classification.BlackHole;
                        break;
                    case "NeutronStar":
                        temp.Classification = Classification.NeutronStar;
                        break;
                    case "DoubleStar":
                        temp.Classification = Classification.DoubleStar;
                        break;
                    case "MultipleStars":
                        temp.Classification = Classification.MultipleStars;
                        break;
                    case "Asterism":
                    ...
                    case "Constellation":
                        ...
                        break;
                    case "OpenCluster":
                        temp.Classification = Classification.OpenCluster;
                        break;
                    case "GlobularCluster":
                        temp.Classification = Classification.GlobularCluster;
                        break;
                    case "NebulousCluster":
                        temp.Classification = Classification.NebulousCluster;
                        break;
                    case "Nebula":
                        temp.Classification = Classification.Nebula;
                        break;
                    case "EmissionNebula":
                        temp.Classification = Classification.EmissionNebula;
                        break;
                    case "PlanetaryNebula":
                        temp.Classification = Classification.PlanetaryNebula;
                        break;
                    case "ReflectionNebula":
                        temp.Classification = Classification.ReflectionNebula;
                        break;
                    case "DarkNebula":
                        temp.Classification = Classification.DarkNebula;
                        break;
                    case "GiantMolecularCloud":
                        temp.Classification = Classification.GiantMolecularCloud;
                        break;
                    case "SupernovaRemnant":
                        temp.Classification = Classification.SupernovaRemnant;
                        break;
                    case "InterstellarDust":
                        temp.Classification = Classification.InterstellarDust;
                        break;
                    case "Quasar":
                        temp.Classification = Classification.Quasar;
                        break;
                    case "Galaxy":
                        temp.Classification = Classification.Galaxy;
                        break;
                    case "SpiralGalaxy":
                        temp.Classification = Classification.SpiralGalaxy;
                        break;
                    case "IrregularGalaxy":
                        temp.Classification = Classification.IrregularGalaxy;
                        break;
                    case "EllipticalGalaxy":
                        temp.Classification = Classification.EllipticalGalaxy;
                        break;
                    case "Knot":
                        temp.Classification = Classification.Knot;
                        break;
                    case "PlateDefect":
                        temp.Classification = Classification.PlateDefect;
                        break;
                    case "ClusterOfGalaxies":
                        temp.Classification = Classification.ClusterOfGalaxies;
                        break;
                    case "OtherNGC":
                        temp.Classification = Classification.OtherNGC;
                        break;
                    case "Unidentified":
                        temp.Classification = Classification.Unidentified;
                        break;
                    case "SolarSystem":
                        temp.Classification = Classification.SolarSystem;
                        break;
                    case "Unfiltered":
                        temp.Classification = Classification.Unfiltered;
                        break;
                    case "Stellar":
                        temp.Classification = Classification.Stellar;
                        break;
                    case "StellarGroupings":
                        temp.Classification = Classification.StellarGroupings;
                        break;
                    case "Nebulae":
                        temp.Classification = Classification.Nebulae;
                        break;
                    case "Galactic":
                        temp.Classification = Classification.Galactic;
                        break;
                    case "Other":
                        temp.Classification = Classification.Other;
                        break;
