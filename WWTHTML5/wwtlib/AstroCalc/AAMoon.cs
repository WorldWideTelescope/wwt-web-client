...
//Static methods
  ...
  public static double ArgumentOfLatitude(double JD)
  {
	...
	double Tcubed = Tsquared *T;
	double T4 = Tcubed *T;
	return CT.M360(93.2720950 + 483202.0175233 *T - 0.0036539 *Tsquared - Tcubed/3526000 + T4/863310000);
  }
  ...
  public static double MeanLongitudePerigee(double JD)
  {
	...
	double Tcubed = Tsquared *T;
	double T4 = Tcubed *T;
	return CT.M360(83.3532465 + 4069.0137287 *T - 0.0103200 *Tsquared - Tcubed/80053 + T4/18999000);
  }
