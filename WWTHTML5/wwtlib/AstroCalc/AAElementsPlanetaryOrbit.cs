...
public class  EPO // was CAAElementsPlanetaryOrbit
{
//Static methods
  ...
  public static double MercuryMeanLongitude(double JD)
  {
	...
	return CT.M360(252.250906 + 149474.0722491 *T + 0.00030350 *Tsquared + 0.000000018 *Tcubed);
  }
  ...
  public static double MercuryInclination(double JD)
  {
	...
	return CT.M360(7.004986 + 0.0018215 *T - 0.00001810 *Tsquared + 0.000000056 *Tcubed);
  }
  ...
  public static double VenusInclination(double JD)
  {
	...
	return CT.M360(3.394662 + 0.0010037 *T - 0.00000088 *Tsquared - 0.000000007 *Tcubed);
  }
  public static double VenusLongitudeAscendingNode(double JD)
  {
	...
	return CT.M360(76.679920 + 0.9011206 *T + 0.00040618 *Tsquared - 0.000000093 *Tcubed);
  }
  public static double VenusLongitudePerihelion(double JD)
  {
	...
	return CT.M360(131.563703 + 1.4022288 *T - 0.00107618 *Tsquared - 0.000005678 *Tcubed);
  }
  ...
  public static double EarthMeanLongitude(double JD)
  {
	...
	return CT.M360(100.466457 + 36000.7698278 *T + 0.00030322 *Tsquared + 0.000000020 *Tcubed);
  }
  ...
  public static double EarthLongitudePerihelion(double JD)
  {
	...
	return CT.M360(102.937348 + 1.17195366 *T + 0.00045688 *Tsquared - 0.000000018 *Tcubed);
  }
  ...
  public static double MarsMeanLongitude(double JD)
  {
	...
	return CT.M360(355.433000 + 19141.6964471 *T + 0.00031052 *Tsquared + 0.000000016 *Tcubed);
  }
  ...
  public static double MarsInclination(double JD)
  {
	...
	return CT.M360(1.849726 - 0.0006011 *T + 0.00001276 *Tsquared - 0.000000007 *Tcubed);
  }
  public static double MarsLongitudeAscendingNode(double JD)
  {
	...
	return CT.M360(49.588093 + 0.7720959 *T + 0.00001557 *Tsquared + 0.000002267 *Tcubed);
  }
  public static double MarsLongitudePerihelion(double JD)
  {
	...
	return CT.M360(336.060234 + 1.8410449 *T + 0.00013477 *Tsquared + 0.000000536 *Tcubed);
  }
  ...
  public static double JupiterMeanLongitude(double JD)
  {
	...
	return CT.M360(34.351519 + 3036.3027748 *T + 0.00022330 *Tsquared + 0.000000037 *Tcubed);
  }
  ...
  public static double JupiterInclination(double JD)
  {
	...
	return CT.M360(1.303267 - 0.0054965 *T + 0.00000466 *Tsquared - 0.000000002 *Tcubed);
  }
  public static double JupiterLongitudeAscendingNode(double JD)
  {
	...
	return CT.M360(100.464407 + 1.0209774 *T + 0.00040315 *Tsquared + 0.000000404 *Tcubed);
  }
  public static double JupiterLongitudePerihelion(double JD)
  {
	...
	return CT.M360(14.331207 + 1.6126352 *T + 0.00103042 *Tsquared - 0.000004464 *Tcubed);
  }
  ...
  public static double SaturnMeanLongitude(double JD)
  {
	...
	return CT.M360(50.077444 + 1223.5110686 *T + 0.00051908 *Tsquared - 0.000000030 *Tcubed);
  }
  ...
  public static double SaturnInclination(double JD)
  {
	...
	return CT.M360(2.488879 - 0.0037362 *T - 0.00001519 *Tsquared + 0.000000087 *Tcubed);
  }
  public static double SaturnLongitudeAscendingNode(double JD)
  {
	...
	return CT.M360(113.665503 + 0.8770880 *T - 0.00012176 *Tsquared - 0.000002249 *Tcubed);
  }
  public static double SaturnLongitudePerihelion(double JD)
  {
	...
	return CT.M360(93.057237 + 1.19637613 *T + 0.00083753 *Tsquared + 0.000004928 *Tcubed);
  }
  ...
  public static double UranusMeanLongitude(double JD)
  {
	...
	return CT.M360(314.055005 + 429.8640561 *T + 0.00030390 *Tsquared + 0.000000026 *Tcubed);
  }
  ...
  public static double UranusInclination(double JD)
  {
	...
	return CT.M360(0.773197 + 0.0007744 *T + 0.00003749 *Tsquared - 0.000000092 *Tcubed);
  }
  public static double UranusLongitudeAscendingNode(double JD)
  {
	...
	return CT.M360(74.005957 + 0.5211278 *T + 0.00133947 *Tsquared + 0.000018484 *Tcubed);
  }
  public static double UranusLongitudePerihelion(double JD)
  {
	...
	return CT.M360(173.005291 + 1.4863790 *T + 0.00021406 *Tsquared + 0.000000434 *Tcubed);
  }
  ...
  public static double NeptuneMeanLongitude(double JD)
  {
	...
	return CT.M360(304.348665 + 219.8833092 *T + 0.00030882 *Tsquared + 0.000000018 *Tcubed);
  }
  ...
  public static double NeptuneInclination(double JD)
  {
	...
	return CT.M360(1.769953 - 0.0093082 *T - 0.00000708 *Tsquared + 0.000000027 *Tcubed);
  }
  public static double NeptuneLongitudeAscendingNode(double JD)
  {
	...
	return CT.M360(131.784057 + 1.1022039 *T + 0.00025952 *Tsquared - 0.000000637 *Tcubed);
  }
  public static double NeptuneLongitudePerihelion(double JD)
  {
	...
	return CT.M360(48.120276 + 1.4262957 *T + 0.00038434 *Tsquared + 0.000000020 *Tcubed);
  }
  ...
  public static double MercuryMeanLongitudeJ2000(double JD)
  {
	...
	return CT.M360(252.250906 + 149472.6746358 *T - 0.00000536 *Tsquared + 0.000000002 *Tcubed);
  }
  public static double MercuryInclinationJ2000(double JD)
  {
	...
	return CT.M360(7.004986 - 0.0059516 *T + 0.00000080 *Tsquared + 0.000000043 *Tcubed);
  }
  public static double MercuryLongitudeAscendingNodeJ2000(double JD)
  {
	...
	return CT.M360(48.330893 - 0.1254227 *T - 0.00008833 *Tsquared - 0.000000200 *Tcubed);
  }
  public static double MercuryLongitudePerihelionJ2000(double JD)
  {
	...
	return CT.M360(77.456119 + 0.1588643 *T - 0.00001342 *Tsquared - 0.000000007 *Tcubed);
  }
  ...
  public static double VenusMeanLongitudeJ2000(double JD)
  {
	...
	return CT.M360(181.979801 + 58517.8156760 *T + 0.00000165 *Tsquared - 0.000000002 *Tcubed);
  }
  public static double VenusInclinationJ2000(double JD)
  {
	...
	return CT.M360(3.394662 - 0.0008568 *T - 0.00003244 *Tsquared + 0.000000009 *Tcubed);
  }
  public static double VenusLongitudeAscendingNodeJ2000(double JD)
  {
	...
	return CT.M360(76.679920 - 0.2780134 *T - 0.00014257 *Tsquared - 0.000000164 *Tcubed);
  }
  public static double VenusLongitudePerihelionJ2000(double JD)
  {
	...
	return CT.M360(131.563703 + 0.0048746 *T - 0.00138467 *Tsquared - 0.000005695 *Tcubed);
  }
  ...
  public static double EarthMeanLongitudeJ2000(double JD)
  {
	...
	return CT.M360(100.466457 + 35999.3728565 *T - 0.00000568 *Tsquared - 0.000000001 *Tcubed);
  }
  ...
  public static double EarthLongitudeAscendingNodeJ2000(double JD)
  {
	...
	return CT.M360(174.873176 - 0.241098 *T + 0.00004262 *Tsquared + 0.000000001 *Tcubed);
  }
  public static double EarthLongitudePerihelionJ2000(double JD)
  {
	...
	return CT.M360(102.937348 + 0.3225654 *T + 0.00014799 *Tsquared - 0.000000039 *Tcubed);
  }
  ...
  public static double MarsMeanLongitudeJ2000(double JD)
  {
	...
	return CT.M360(355.433000 + 19140.2993039 *T + 0.00000262 *Tsquared - 0.000000003 *Tcubed);
  }
  public static double MarsInclinationJ2000(double JD)
  {
	...
	return CT.M360(1.849726 - 0.0081477 *T - 0.00002255 *Tsquared - 0.000000029 *Tcubed);
  }
  public static double MarsLongitudeAscendingNodeJ2000(double JD)
  {
	...
	return CT.M360(49.588093 - 0.2950250 *T - 0.00064048 *Tsquared - 0.000001964 *Tcubed);
  }
  public static double MarsLongitudePerihelionJ2000(double JD)
  {
	...
	return CT.M360(336.060234 + 0.4439016 *T - 0.00017313 *Tsquared + 0.000000518 *Tcubed);
  }
