...
public class  GMD // was CAAGalileanMoonDetail
{
...
//Member variables
  ...
  public double r;
  public C3D EclipticRectangularCoordinates = new C3D();
  public C3D TrueRectangularCoordinates = new C3D();
  public C3D ApparentRectangularCoordinates = new C3D();
  public bool bInTransit;
  public bool bInOccultation;
  public bool bInEclipse;
  public bool bInShadowTransit;
  public C3D ApparentShadowRectangularCoordinates = new C3D();
}

public class  GMDS //was CAAGalileanMoonsDetails
{
//Member variables
  public GMD Satellite1 = new GMD();
  public GMD Satellite2 = new GMD();
  public GMD Satellite3 = new GMD();
  public GMD Satellite4 = new GMD();
}


public class  GM //was CAAGalileanMoons
{
//Static methods
...
//ORIGINAL LINE: details1.Satellite4.ApparentShadowRectangularCoordinates = details2.Satellite4.ApparentRectangularCoordinates;
  ...
  protected static void FillInPhenomenaDetails( GMD detail)
  {
