...
//Static methods
  ...
  public static double TrueGreatestDeclination(double k, bool bNortherly)
  {
	...
	D = CT.M360(D + 333.0705546 *k - 0.0004214 *T2 + 0.00000011 *T3);
	double M = bNortherly ? 14.8591 : 1.3951;
	M = CT.M360(M + 26.9281592 *k - 0.0000355 *T2 - 0.00000010 *T3);
	double Mdash = bNortherly ? 4.6881 : 186.2100;
	Mdash = CT.M360(Mdash + 356.9562794 *k + 0.0103066 *T2 + 0.00001251 *T3);
	double F = bNortherly ? 325.8867 : 145.1633;
	F = CT.M360(F + 1.4467807 *k - 0.0020690 *T2 - 0.00000215 *T3);
